...
class _PostRepliesSheetContentState extends ConsumerState<_PostRepliesSheetContent> {
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: _buildPostContent(post, onMenuRegistered: (cb) => menuCallback = cb),
          ),
        ),
      ),
    );
      ...
      child: AnimatedContainer(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: 8),
              child: _buildPostContent(reply, onMenuRegistered: (cb) => menuCallback = cb),
            ),
          ),
        ),
      ),
  ...
  /// 帖子内容：头部 + 正文（可引用） + 操作栏
  Widget _buildPostContent(Post post, {required ValueChanged<VoidCallback> onMenuRegistered}) {
    return Column(
      ...
      children: [
        ...
        SelectionContainer.disabled(
          child: PostFooterSection(
            ...
            onMenuRegistered: onMenuRegistered,
          ),
        ),
      ],
    );
